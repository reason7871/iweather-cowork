 ...
 * PreferencesPage
 *
 * Form-based editor for stored user preferences (~/.iweather/preferences.json).
 * Features:
...
export default function PreferencesPage() {
  ...
  return (
    <div className="h-full flex flex-col">
      <PanelHeader title={t('preferencesPage.title')} actions={<HeaderMenu route={routes.view.settings('preferences')} helpFeature="preferences" />} />
      <div className="flex-1 min-h-0 mask-fade-y">
        <ScrollArea className="h-full">
          <div className="px-5 py-7 max-w-3xl mx-auto space-y-8">
          {/* Basic Info */}
          <SettingsSection
            title={t('preferencesPage.basicInfo')}
            description={t('preferencesPage.basicInfoDesc')}
          >
            <SettingsCard divided>
              <SettingsInput
                label={t('preferencesPage.prefName')}
                description={t('preferencesPage.prefNameDesc')}
                value={formState.name}
                onChange={(v) => updateField('name', v)}
                placeholder={t('preferencesPage.prefNamePlaceholder')}
                inCard
              />
              <SettingsInput
                label={t('preferencesPage.prefTimezone')}
                description={t('preferencesPage.prefTimezoneDesc')}
                value={formState.timezone}
                onChange={(v) => updateField('timezone', v)}
                placeholder={t('preferencesPage.prefTimezonePlaceholder')}
                inCard
              />
              <SettingsInput
                label={t('preferencesPage.prefLanguage')}
                description={t('preferencesPage.prefLanguageDesc')}
                value={formState.language}
                onChange={(v) => updateField('language', v)}
                placeholder={t('preferencesPage.prefLanguagePlaceholder')}
                inCard
              />
            </SettingsCard>
          </SettingsSection>
          ...
          {/* Location */}
          <SettingsSection
            title={t('preferencesPage.location')}
            description={t('preferencesPage.locationDesc')}
          >
            <SettingsCard divided>
              <SettingsInput
                label={t('preferencesPage.prefCity')}
                description={t('preferencesPage.prefCityDesc')}
                value={formState.city}
                onChange={(v) => updateField('city', v)}
                placeholder={t('preferencesPage.prefCityPlaceholder')}
                inCard
              />
              <SettingsInput
                label={t('preferencesPage.prefCountry')}
                description={t('preferencesPage.prefCountryDesc')}
                value={formState.country}
                onChange={(v) => updateField('country', v)}
                placeholder={t('preferencesPage.prefCountryPlaceholder')}
                inCard
              />
            </SettingsCard>
          </SettingsSection>
          ...
          {/* Notes */}
          <SettingsSection
            title={t('preferencesPage.notes')}
            description={t('preferencesPage.notesDesc')}
            action={
          ...
          >
            <SettingsCard divided={false}>
              <SettingsTextarea
                ...
                placeholder={t('preferencesPage.notesPlaceholder')}
                rows={5}
                inCard
              />
            </SettingsCard>
