...
import type { StatusConfig } from '@iweather/shared/statuses'
import { isEmoji } from '@iweather/shared/utils/icon-constants'
import { resolveEntityColor, getDefaultStatusColor } from '@iweather/shared/colors'
import type { EntityColor } from '@iweather/shared/colors'
