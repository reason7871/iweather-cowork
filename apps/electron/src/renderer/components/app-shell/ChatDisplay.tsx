...
import { TurnCard, UserMessageBubble, groupMessagesByTurn, formatTurnAsMarkdown, formatActivityAsMarkdown, type Turn, type AssistantTurn, type UserTurn, type SystemTurn, type AuthRequestTurn } from "@iweather/ui"
...
import { flattenLabels } from "@iweather/shared/labels"
...
interface ChatDisplayProps {
  ...
  labels?: import('@iweather/shared/labels').LabelConfig[]
...
export const ChatDisplay = React.forwardRef<ChatDisplayHandle, ChatDisplayProps>(function ChatDisplay({
  ...
  // These settings are stored in ~/.iweather/preferences.json (not localStorage)
  ...
  // Uses the shared extractOverlayData parser from @iweather/ui
