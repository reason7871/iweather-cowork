...
import { usePlatform } from '@iweather/ui'
  ...
  'add-skill': (location) => ({
    context: {
      ...
      context:
        ...
        'Follow the patterns in ~/.iweather/docs/skills.md. ' +
  ...
  'edit-labels': (location) => ({
    context: {
      ...
      context:
        ...
        'Read ~/.iweather/docs/labels.md for full format reference. ' +
        'Confirm clearly when done.',
    },
  ...
  'edit-tool-icons': (location) => ({
    context: {
      ...
      context:
        ...
        'The file is tool-icons.json in ~/.iweather/tool-icons/. Icon image files live in the same directory. ' +
        ...
        'Read ~/.iweather/docs/tool-icons.md for full format reference. ' +
