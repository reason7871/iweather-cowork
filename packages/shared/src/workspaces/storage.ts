 ...
 * Default location: ~/.iweather/workspaces/
 */
...
/**
 * Get the default workspaces directory (~/.iweather/workspaces/)
 */
 ...
 * @param baseDir - Parent directory where workspace folders live (e.g., ~/.iweather/workspaces/)
 ...
 * Returns paths to valid workspaces found in ~/.iweather/workspaces/
 */
