 ...
 * Guides are now served exclusively via the iweather-docs MCP server.
 *
 ...
 * Use the iweather-docs MCP server to search for setup guides.
 *
 * Example: mcp__iweather-docs__SearchCraftAgents({ query: "github source setup guide" })
 */
