 ...
 *
 * File locations:
 * - Workspace: ~/.iweather/workspaces/{slug}/permissions.json
 * - Per-source: ~/.iweather/workspaces/{slug}/sources/{sourceSlug}/permissions.json
 *
 ...
 * Default permissions are stored at ~/.iweather/permissions/
 */
...
/**
 * Load default permissions from ~/.iweather/permissions/default.json
...
class PermissionsConfigCache {
  ...
  // App-level default permissions (loaded from ~/.iweather/permissions/default.json)
   ...
   * These come from ~/.iweather/permissions/default.json
   */
