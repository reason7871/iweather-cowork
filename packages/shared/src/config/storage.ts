...
import type { StoredAttachment, StoredMessage } from '@iweather/core/types';
...
import type { Workspace, AuthType } from '@iweather/core/types';
...
/**
 * Load config defaults from ~/.iweather/config-defaults.json
...
export function ensureConfigDir(): void {
  ...
  // Initialize bundled docs (creates ~/.iweather/docs/ with sources.md, agents.md, permissions.md)
  initializeDocs();
...
export type { StoredAttachment, StoredMessage } from '@iweather/core/types';
 ...
 * Preset themes are stored at ~/.iweather/themes/
 */
...
/**
 * Returns the path to the tool-icons directory: ~/.iweather/tool-icons/
 */
