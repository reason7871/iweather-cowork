...
const systemPrompt = getSystemPrompt(
  ...
  '/Users/example/.iweather/workspaces/abc123' // Example workspace path
);
...
const systemPromptWithDebug = getSystemPrompt(
  undefined,
  { enabled: true, logFilePath: '~/Library/Logs/@iweather/electron/main.log' },
  '/Users/example/.iweather/workspaces/abc123'
);
...
const sessionState = formatSessionState('260121-example-session', {
  plansFolderPath:
    '/Users/example/.iweather/workspaces/abc123/sessions/260121-example-session/plans',
});
...
${colors.bold}Key Files:${colors.reset}
  ...
  packages/shared/src/agent/iweather-agent.ts       ${colors.dim}// User message building${colors.reset}
