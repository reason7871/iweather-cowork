...
This file provides guidance to Claude Code when working with the `@iweather/core` package.
...
import type { Session } from '@iweather/core/types';
```
...
2. **Phase 2:** Move storage logic to `@iweather/core`
